...
export const metadata = {
  title: "Qdrant Multi-Modal Home Search",
  description:
    "Search for houses by describing what you're looking for — from Victorian architecture to modern interiors, our vector search understands your preferences and finds visually similar properties.",
  ...
  icons: {
    icon: [{ url: "/logomark.svg", type: "image/svg+xml" }],
                ...
                <div className="flex items-center">
                  <div className="font-semibold text-xl text-foreground flex items-center">
                    <a
                      ...
                      className="font-bold mr-1 text-amaranth hover:text-amaranth/80"
                    >
                      Qdrant
                    </a>
                    <Link
                      href="/"
                      className="font-bold mr-1 hover:text-gray-600 transition-colors"
                    >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center text-gray-500 text-sm">
                ...
                <p>
                  Images from{" "}
                  <a
                    href="https://github.com/emanhamed/Houses-dataset"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#2F6FF0] hover:underline"
                  >
                ...
                <p className="mt-1">
                  © {new Date().getFullYear()} Qdrant Multi-modal Home Search.
                  All rights reserved.
                </p>
              </div>
            </div>
